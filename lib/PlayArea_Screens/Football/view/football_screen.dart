...
class _FootballScreenState extends State<FootballScreen> with OnInit{
  late FootballProvider controller;
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    int rate = CreationPageConfig.getRate('football');
                      ...
                      children: [
                        if (isMobile) ...[
                          ...
                          _buildInputField(
                            ...
                            Iconsax.calendar,
                            isMobile: isMobile,
                            options: ['Football Turf 1', 'Football Turf 2'],
                    ...
                    if (_formKey.currentState!.validate()){
                      await controller.football(
                          success: (){
                            ...
                            controller. turfNameController.clear();
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    controller = Provider.of<FootballProvider>(context, listen: false);

...
class _TabletennisScreenState extends State<TabletennisScreen> with OnInit{
  late TableTennisProvider controller;
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    int rate = CreationPageConfig.getRate('tennis');
    ...
    return Scaffold(
      ...
      body: Consumer<TableTennisProvider>(
  ...
  Widget _buildFooterButtons(BuildContext context, bool isMobile) {
    return Consumer<TableTennisProvider>(
        builder: (context, controller, child) {
          return Container(
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    controller = Provider.of<TableTennisProvider>(context, listen: false);

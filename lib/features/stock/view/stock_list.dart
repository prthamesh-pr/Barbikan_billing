import 'package:billing_web/features/stock/viewModel/stock_provider.dart';
...
class _StockListViewState extends State<StockListView>  with OnInit{
      ...
      builder: (context, controller, child) {
        return Column(
          children:[
            ...
            itemCount: controller.listOfStockItems.length,
            itemBuilder: (context, index){
              final item = controller.listOfStockItems[index];
              return Card(
                color: Colors.white,
                              ...
                              if (value == 'edit') {
                                ...
                                if (confirmDelete == true) {
                                  // print("user.id!===${user.id!}");
                                    await controller.deleteStock(item.id!);
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      TextFormField(
                        controller: controller.skuItemCodeController,
                        decoration: InputDecoration(
                          labelText: 'SKU',
                          border: OutlineInputBorder(),
                        ),
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      final buyingPrice = double.tryParse(
                          controller.buyingPriceController.text) ?? 0.0;

                      final calculatedPrice = quantity * buyingPrice;
                      controller.priceController.text =
                          calculatedPrice.toStringAsFixed(2);

                      await controller.newStock(
                        success: () {
                          controller.skuItemCodeController.clear();
                          controller.quantityController.clear();
                          controller.productNameController.clear();
                          controller.categoryNameController.clear();
                          controller.buyingPriceController.clear();
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    Provider.of<StockProvider>(context , listen: false).inItState();
  }
}

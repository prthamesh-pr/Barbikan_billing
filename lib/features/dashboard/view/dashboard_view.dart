...
class _DashboardViewState extends State<DashboardView> with OnInit {
          ...
          children: [
            ...
            GridView(
              ...
              children: [
                cardView(
                  title: "Sales",
                  value: formatNumber(controller.topDashBoardList.isNotEmpty
                      ? controller.topDashBoardList[0].data!.totalSalesProductMonth ?? 0
                      : 0),
                ...
                cardView(
                  title: "Purchase",
                  value: formatNumber(controller.topDashBoardList.isNotEmpty
                      ? controller.topDashBoardList[0].data!.totalPurchaseProductMonth ?? 0
                      : 0),
            ...
            GridView(
              ...
              children: [
                cardView(
                  title: "Today Sales",
                  value: formatNumber(controller.topDashBoardList.isNotEmpty
                      ? controller.topDashBoardList[0].data!.totalSalesProductToday ?? 0
                      : 0),
                ...
                cardView(
                  title: "Products",
                  value:  formatNumber(controller.topDashBoardList.isNotEmpty
                      ? controller.topDashBoardList[0].data!.totalProducts ?? 0
                      : 0),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DataTable(
                      ...
                      rows: controller.dashBoardList.map((product) {
                            return DataRow(
                              cells: [
                                DataCell(
                                  FittedBox(
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    Provider.of<DashBoardProvider>(context, listen: false).initState();
  }
}

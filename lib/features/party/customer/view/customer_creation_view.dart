        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              await model.newCustomer(
              success: (){
              model. companyNameController.clear();
              model.phoneController.clear();
              model.alterNativeMobileController.clear();
              model.gstNumberController.clear();
              model.partyNameController.clear();
              model.emailController.clear();
              model.billingAddressController.clear();
              model.billingCityNameController.clear();
              model.billingStateNameController.clear();
              model.categoryController.clear();
              model.openingBalanceController.clear();
              model.shippingAddressController.clear();
              model.shippingCityNameController.clear();
              model.shippingStateNameController.clear();
              model.openingDateController.clear();

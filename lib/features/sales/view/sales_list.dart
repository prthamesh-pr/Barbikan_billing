...
class _SalesListState extends State<SalesList> with OnInit{
   ...
   // final sales = filteredSales;
    ...
    return Consumer<SalesProvider>(
        builder: (context, controller, child) {
          final sales = controller.listOfSales;
          if (sales.isEmpty) {
                    ...
                    children: [
                      Text(
                        sale.totalAmount != null
                            ? "\₹${double.parse(sale.totalAmount!).toStringAsFixed(2)}"
                            : "\₹0.00",
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 18,
                            ...
                            onTapDown: (TapDownDetails details) async {
                              ...
                              if (value == 'edit') {
                                ...
                                if (confirmDelete == true) {
                                  ...
                                  await controller.deleteSales(sale.id!);
  ...
  void afterFirstLayout(BuildContext context) {
    ...
    Provider.of<SalesProvider>(context , listen: false).inItState();
  }
}
